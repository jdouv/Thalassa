$(document).ready(()=> {
    ...
    $.getJSON('../locales.json').then((localesJson) => {
        ...
        function notifyError(text, jqXHR) {
            ...
            <div class="messageErrorMessage" style="font-size:16px;"><span data-localization="errorMessage"></span><br/>${jqXHR.responseText}</div>`;
