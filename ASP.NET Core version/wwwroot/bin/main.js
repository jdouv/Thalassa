...
$(document).ready(() => {
    ...
    $.getJSON('/User/Localization').then(localesJson => {
        ...
        // Checks if error message is text
        ...
        function generateKeys() {
            ...
            $.post('/User/GenerateKeys', response => {
            ...
            function renderAdminNavbar() {
                ...
                setTimeout(function() {
                    ...
                    render(h(() => {
                        return (
                            h("li", {
                                    class: "dropdown navButDropdown animate slideIn"},
        ...
        function companyVesselsRegistryManagerView(responseJson) {
            ...
            $(document).on('click', '.navCompanyVesselsRegistryManager', function() {
                ...
                openWait();
                setTimeout(() => {
                    $.post('/Vessels/VesselsRegistry', response => {
                        closeWait();
                        main.empty();
                    ...
                    if (firstResponse.hasOwnProperty('invalidFields'))
                        ...
                        if (firstResponse.hasOwnProperty('saved')) {
                            if (firstResponse['saved'] === true) {
                                ...
                                $.post('/Vessels/VesselsRegistry', secondResponse => {
