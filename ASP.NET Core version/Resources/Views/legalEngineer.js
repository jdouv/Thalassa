...
function renderAllContracts(json) {
    render(html`<div class="container bg-text userContracts animate slideIn">
                ${json.length < 1 ?
                    html`<div class="row">
                        <div class="col">
...
$(document).on('click', '.contractRow', function(e) {
    e.stopImmediatePropagation();
                        ...
                        <div class="collapse" id="essentials">
                            <div class="card card-body">
                                ${composedContract['contract']['essentials']['type'] === 'timeCharter' ?
                                    html`<span>${composedContract['contract']['essentials']['preamble']}</span>
                                        <div class="row justify-content-center essentialsData">
                                            <div class="col-auto infoBox">
                                                <div class="contractIcon vesselIcon">
                                                    <svg viewBox="0 0 542 281">
                                                            ...
                                                            ${$.map(clause['paragraphs'], paragraph => {
                                                                return (
                                                                    html`<div class="paragraphGroup">
                                                                        <div class="paragraphNumber">${paragraph['number']}.</div>
                                                                        <div class="paragraphText">${paragraph['readable']}</div>
                                                                    </div>`
                                                                )
                                                            })}
                                                        </div>
                                                        <div class="col paragraphLegen animate slideIn" style="display:none;">
                                                            <div class="clauseSubtitle animate slideIn" style="display:none;">Legen</div>
                                                            ${$.map(clause['paragraphs'], paragraph => {
                                                                return (
                                                                    html`<div class="paragraphGroup">
                                                                        <div class="paragraphNumber">${paragraph['number']}.</div>
                                                                        <div class="paragraphText">${paragraph['legen']}</div>
                                                                    </div>`
                                                                )
                                                            })}
                                                        </div>
...
$(document).on('click', '.enableClause', e => {
    e.stopImmediatePropagation();
    $.post('/Contracts/TestEnableClause', response => {
